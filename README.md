...
python tests/test_atles_system.py   python test_function_call_debug.py
...
# R-Zero integration tests

python tests/test_r_zero_integration.py#### **Constitutional AI Chat**

```python

# Memory system testsfrom atles import create_lightweight_constitutional_client
